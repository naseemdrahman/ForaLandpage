  ...
  try {
    ...
    try {
      ...
      if (data.ok === false && data.error) {
        ...
        console.warn('[Contact] Apps Script returned explicit error but data may be saved:', data.error);
      ...
      console.log('[Contact] Non-JSON response from Apps Script (status ' + response.status + '). Data was saved, treating as success.');
      return { success: true };
    }
  } catch (error: any) {
